...
<head>
    ...
    <link rel="stylesheet" href="front/assets/owlcarousel/owl.carousel.css">
    <link rel="stylesheet" href="front/assets/owlcarousel/owl.theme.css">

    <link href="front/css/superfish.css" rel="stylesheet" media="screen">
    ...
    <link rel="stylesheet" type="text/css" href="front/css/parallax-slider/parallax-slider.css" />
    <script type="text/javascript" src="front/js/parallax-slider/modernizr.custom.28468.js"></script>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-close-others="false" data-delay="0"
                            data-hover=
                      "dropdown" data-toggle="dropdown" href="index.html">Home
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-close-others="false" data-delay="0"
                            data-hover=
                      "dropdown" data-toggle="dropdown" href="#">Feature
                            <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-close-others="false" data-delay="0"
                            data-hover=
                      "dropdown" data-toggle="dropdown" href="#">Pages
                            <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                    ...
                    <li class="dropdown">
                      ...
                      "dropdown" data-toggle="dropdown"
                            href="#">Portfolio <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-close-others="false" data-delay="0"
                            data-hover=
                      "dropdown" data-toggle="dropdown" href="#">Blog
                            <i class="fa fa-angle-down"></i>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="da-img">
                            <img src="front/img/parallax-slider/images/2.png" alt="image01" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="da-img">
                            <img src="front/img/parallax-slider/images/3.png" alt="image01" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="da-img">
                            <img src="front/img/parallax-slider/images/1.png" alt="image01" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="feature-box">
                    ...
                    <div class="col-md-4 col-sm-4 text-center wow fadeInUp">
                        <div class="feature-box-heading">
                            <em>
                                <img src="front/img/3.png" alt="" width="100" height="100">
                            </em>
                            <h4>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-6 text-center wow fadeInLeft">
                    <img src="front/img/tab1.png" alt="">
                </div>
                <div class="col-lg-6 col-sm-6 wow fadeInRight">
                    ...
                    <p>
                        ...
                        laudantium, totam rem aperiam, eaque ipsa quae ablic jiener. natus error sit voluptatem
                        accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ablic jiener. natus error
                        sit voluptatem accusantiu.
                    </p>
                    <p>
                        <i class="fa fa-check fa-lg pr-10">
                        </i>
                    ...
                    <p>
                        ...
                        Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                        laudantium, totam rem aperiam, eaque ipsa quae ablic jiener.
                    </p>
                    <hr>
                    ...
                    <div class="panel-body">
                        <div class="tab-content tasi-tab">
                            <div id="news" class="tab-pane fade in active">
                                <article class="media">
                                    <a class="pull-left thumb p-thumb">
                                        <img src="front/img/product1.jpg" alt="">
                                    </a>
                                ...
                                <article class="media">
                                    <a class="pull-left thumb p-thumb">
                                        <img src="front/img/product2.jpg" alt="">
                                    </a>
                                    <div class="media-body b-btm">
                                        <a href="#" class=" p-head">
                            ...
                            <div id="notice-board" class="tab-pane fade">
                                <p>
                                    Notice board goes here Sed ut perspiciatis unde omnis iste natus error sit
                            ...
                            <ul class="slides about-flex-slides">
                                <li>
                                    <div class="about-testimonial-image ">
                                        <img alt="" src="front/img/person_1.png">
                                    </div>
                                    ...
                                    <div class="about-testimonial-content">
                                        <p class="about-testimonial-quote">
                                            Donec ut purus sed tortor malesuada venenatis eget eget lorem. Nullam tempor
                                            lectus a ligula lobortis pretium. Donec ut purus sed tortor malesuada
                                            venenatis eget eget lorem.
                                        </p>
                                    </div>
                                </li>
                                <li>
                                    <div class="about-testimonial-image ">
                                        <img alt="" src="front/img/person_2.png">
                                    </div>
                                    <a class="about-testimonial-author" href="#">
                                        Steven gerrard
                                    </a>
                                    ...
                                    <div class="about-testimonial-content">
                                        <p class="about-testimonial-quote">
                                            Pellentesque et pulvinar enim. Quisque at tempor ligula. Maecenas augue
                                            ante, euismod vitae egestas sit amet, accumsan eu nulla. Nullam tempor
                                            lectus a ligula lobortis pretium. Donec ut purus sed tortor malesuada
                                            venenatis eget eget lorem.
                                        </p>
                                    </div>
                ...
                <div class="col-lg-12 recent">
                    ...
                    <div id="owl-demo" class="owl-carousel owl-theme wow fadeIn">
                        ...
                        <div class="item view view-tenth">
                            <img src="front/img/works/img8.jpg" alt="work Image">
                            <div class="mask">
                        ...
                        <div class="item view view-tenth">
                            <img src="front/img/works/img9.jpg" alt="work Image">
                            <div class="mask">
                                <a href="blog-detail.html" class="info" data-toggle="tooltip" data-placement="top"
                                    title="Details">
                                    <i class="fa fa-link">
                        ...
                        <div class="item view view-tenth">
                            <img src="front/img/works/img10.jpg" alt="work Image">
                            <div class="mask">
                                <a href="blog-detail.html" class="info" data-toggle="tooltip" data-placement="top"
                                    title="Details">
                                    <i class="fa fa-link">
                        ...
                        <div class="item view view-tenth">
                            <img src="front/img/works/img11.jpg" alt="work Image">
                            <div class="mask">
                                <a href="blog-detail.html" class="info" data-toggle="tooltip" data-placement="top"
                                    title="Details">
                                    <i class="fa fa-link">
                        ...
                        <div class="item view view-tenth">
                            <img src="front/img/works/img12.jpg" alt="work Image">
                            <div class="mask">
                                <a href="blog-detail.html" class="info" data-toggle="tooltip" data-placement="top"
                                    title="Details">
                                    <i class="fa fa-link">
                        ...
                        <div class="item view view-tenth">
                            <img src="front/img/works/img13.jpg" alt="work Image">
                            <div class="mask">
                                <a href="blog-detail.html" class="info" data-toggle="tooltip" data-placement="top"
                                    title="Details">
                                    <i class="fa fa-link">
        ...
        <div class="row mar-b-50 our-clients">
            ...
            <div class="col-md-9">
                ...
                <ul class="bxslider1 clients-list">
                    <li>
                        <a href="#">
                            <img src="front/img/clients/graylogo6.png" alt="" />

                            <img src="front/img/clients/newlogo6.png" class="color-img" alt="" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-3 address wow fadeInUp" data-wow-duration="2s" data-wow-delay=".1s">
                    ...
                    <address>
                        ...
                        <p><i class="fa fa-envelope pr-10"></i>Email : <a href="javascript:;">support@example.com</a>
                        </p>
                    </address>
                </div>
...
-->
    ...
    <script type="text/javascript" src="front/js/parallax-slider/jquery.cslider.js"></script>
